...
Compra de Passagem
    ...
    Quando seleciono a origem como "São Paolo" e seleciono o destino como "New York"
...
Quando seleciono a origem como "${origem}" e seleciono o destino como "${destino}"
